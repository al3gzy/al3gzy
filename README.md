...
- **Self-Healing Material** - Simulating the healing process of materials by modeling diffusion, adsorption and stress dynamics in a 1D domain, evaluating crack closure efficiency based on concentration dynamics and stress distribution over time. [repo](https://github.com/al3gzy/self_healing_rd_eq)
